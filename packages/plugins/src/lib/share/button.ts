...
const ShareButton = defineCustomElement(NAME, () => class ShareButton extends HTMLElement {
    constructor() {
        super();
...
const createButton = (onclick: () => void) => {
    const button = document.createElement(NAME) as InstanceType<typeof ShareButton>;
