...
| `easing`     | `(t) => t`         | `function` | Easing function: `t value from 1 to 0`. See more in [easing.ts](https://github.com/Valexr/Slidy/blob/master/packages/core/src/easing.ts). Available from `@slidy/core/dist/easing`.|
