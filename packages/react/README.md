<div align="center">
    <a href="https://www.npmjs.com/package/@slidy/react">
        <img alt="npm package version" src="https://img.shields.io/npm/v/@slidy/react?style=flat-square" />
    </a>
    <a href="https://www.npmjs.com/package/@slidy/react">
        <img alt="types included" src="https://img.shields.io/npm/types/@slidy/react?style=flat-square" />
    </a>
    <a href="https://www.npmjs.com/package/@slidy/react">
        <img alt="downloads count" src="https://img.shields.io/npm/dm/@slidy/react?style=flat-square" />
    </a>
    <a href="https://www.npmjs.com/package/@slidy/react">
...
Simple, configurable & reusable carousel component built with React based on [@slidy/core](https://github.com/Valexr/slidy/tree/master/packages/core).

Try the [demo](https://codesandbox.io/s/slidy-react-demo-64wllu?file=/src/App.tsx).

## Getting started

The package is available via [npm](https://www.npmjs.com/package/@slidy/react):
