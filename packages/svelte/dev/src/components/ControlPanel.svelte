<form class="controls">
		...
		<section>
				...
				<fieldset class="flex-horizontal">
						<label>
								<input type="checkbox" checked={vertical} on:change={() => vertical = !vertical}>
								<span>Vertical</span>
						</label>
						<label>
								<input type="checkbox" checked={clamp} on:change={() => clamp = !clamp}>
								<span>Clamp</span>
						</label>
						<label>
								<input type="checkbox" checked={snap} on:change={() => snap = !snap}>
								<span>Snap</span>
						</label>
						<label>
								<input type="checkbox" checked={loop} on:change={() => loop = !loop}>
								<span>Loop</span>
						</label>
				</fieldset>
		</section>
...
<style>
    ...
    .controls .flex-horizontal label {
        flex-direction: row;
        align-items: center;
    }
</style>