(() => {
  ...
  function slidy(node, {
    ...
    onMounted(node).then((childs) => {
      ...
      replace(node, index, loop, vertical);
      to(index);
      if (PARENT) {
        RO.observe(node);
    ...
    function to(index2, target = null) {
      toing = true;
      clear();
      index2 = indexing(node, index2, loop);
      hix = loop ? hix : index2;
  ...
  var get_dots_arrow_right_slot_context_1 = (ctx) => ({ item: ctx[26] });
  var get_dots_arrow_right_slot_changes = (dirty) => ({ item: dirty & 768 });
  var get_dots_arrow_right_slot_context = (ctx) => ({ item: ctx[26] });
  ...
  var get_dots_arrow_left_slot_context_1 = (ctx) => ({ item: ctx[26] });
  var get_dots_arrow_left_slot_changes = (dirty) => ({ item: dirty & 768 });
  var get_dots_arrow_left_slot_context = (ctx) => ({ item: ctx[26] });
  var get_arrow_right_slot_changes_1 = (dirty) => ({ item: dirty & 768 });
  var get_arrow_right_slot_context_1 = (ctx) => ({ item: ctx[26] });
  var get_arrow_left_slot_changes_1 = (dirty) => ({ item: dirty & 768 });
  var get_arrow_left_slot_context_1 = (ctx) => ({ item: ctx[26] });
  var get_arrow_right_slot_changes = (dirty) => ({ item: dirty & 768 });
  var get_arrow_right_slot_context = (ctx) => ({ item: ctx[26] });
  var get_arrow_left_slot_changes = (dirty) => ({ item: dirty & 768 });
  var get_arrow_left_slot_context = (ctx) => ({ item: ctx[26] });
  ...
  var get_default_slot_context = (ctx) => ({ item: ctx[26] });
  var get_loader_slot_changes = (dirty) => ({ item: dirty & 768 });
  var get_loader_slot_context = (ctx) => ({ item: ctx[26] });
  ...
  function create_then_block(ctx) {
    ...
    const get_key = (ctx2) => ctx2[2](ctx2[26]);
    ...
    return {
      ...
      p(ctx2, dirty) {
        ...
        if (slidy_action && is_function(slidy_action.update) && dirty & 75)
  ...
  function create_if_block_11(ctx) {
    ...
    return {
      c() {
        img = element("img");
        attr(img, "alt", img_alt_value = ctx[26][ctx[4].imgsrckey]);
        if (!src_url_equal(img.src, img_src_value = ctx[26][ctx[4].imgsrckey]))
          attr(img, "src", img_src_value);
        attr(img, "width", img_width_value = ctx[26].width);
        attr(img, "height", img_height_value = ctx[26].height);
      },
      m(target, anchor) {
        insert(target, img, anchor);
      },
      p(ctx2, dirty) {
        if (dirty & 784 && img_alt_value !== (img_alt_value = ctx2[26][ctx2[4].imgsrckey])) {
          attr(img, "alt", img_alt_value);
        }
        if (dirty & 784 && !src_url_equal(img.src, img_src_value = ctx2[26][ctx2[4].imgsrckey])) {
          attr(img, "src", img_src_value);
        }
        if (dirty & 768 && img_width_value !== (img_width_value = ctx2[26].width)) {
          attr(img, "width", img_width_value);
        }
        if (dirty & 768 && img_height_value !== (img_height_value = ctx2[26].height)) {
  ...
  function create_each_block_1(key_2, ctx) {
    ...
    return {
      ...
      c() {
        ...
        t = space();
        attr(li, "data-id", li_data_id_value = ctx[26].ix);
        attr(li, "class", li_class_value = null_to_empty(ctx[4].class) + " svelte-1q6igjy");
        attr(li, "style", li_style_value = ctx[4].backimg === true ? `background-image: url(${ctx[26][ctx[4].imgsrckey]})` : null);
        toggle_class(li, "active", ctx[26].ix === ctx[0]);
        this.first = li;
      },
      m(target, anchor) {
      ...
      p(new_ctx, dirty) {
        ...
        if (!current || dirty & 768 && li_data_id_value !== (li_data_id_value = ctx[26].ix)) {
        ...
        if (!current || dirty & 784 && li_style_value !== (li_style_value = ctx[4].backimg === true ? `background-image: url(${ctx[26][ctx[4].imgsrckey]})` : null)) {
  ...
  function fallback_block_2(ctx) {
    let button;
    let t_value = (ctx[5].dotsnum && !ctx[5].dotspure ? ctx[25] : "") + "";
    let t;
    return {
      c() {
        button = element("button");
      ...
      p(ctx2, dirty) {
        if (dirty & 32 && t_value !== (t_value = (ctx2[5].dotsnum && !ctx2[5].dotspure ? ctx2[25] : "") + ""))
          set_data(t, t_value);
      },
      d(detaching) {
        if (detaching)
  ...
  function create_each_block(ctx) {
    ...
    return {
      c() {
        ...
        toggle_class(li, "active", ctx[25] === ctx[0]);
      },
      m(target, anchor) {
        insert(target, li, anchor);
        if (dot_slot_or_fallback) {
  ...
  function instance2($$self, $$props, $$invalidate) {
    let dark;
    "use strict";
    let items = [], position2 = 0, page = randomQ(0, 90), limit = 13, index = 0, vertical = false, clamp = false, align = "middle", duration = 375, stend = false, gravity = 1.2, width = "auto", snap = true, images = true, loop = true, gap = 16;
