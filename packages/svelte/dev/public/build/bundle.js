(() => {
  ...
  function instance2($$self, $$props, $$invalidate) {
    let dark;
    "use strict";
    let items = [], position2 = 0, page = randomQ(0, 90), limit = 15, index = 7, vertical = false, clamp = false, align = "middle", duration = 375, stend = false, gravity = 1.2, width = "auto", snap = true, images = true, loop = false, gap = 16;
