  ...
  function slidy(node, options = {
    ...
    function move({ pos, transition = 0 }) {
      ...
      function translate(vertical) {
        return vertical ? `0, ${-position2}px, 0` : `${-position2}px, 0, 0`;
      }
      const styles = {
