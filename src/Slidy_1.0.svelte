...
<section class="svelte-slidy" use:resizeobserver on:resizeob="{resizeWrap}" id="{wrap.id}" use:wheel on:wheels="{controls.wheel ? slidyWheel : null}" style="--wrapwidth: {wrap.width}; --wrapheight: {wrap.height};">
	<ul
